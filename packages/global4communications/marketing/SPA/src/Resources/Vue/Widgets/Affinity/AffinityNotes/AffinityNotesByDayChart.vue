...
<script>
    ...
    export default {
        name: 'affinity-notes-by-day-chart',
        template: 'affinity-notes-by-day-chart',
        mixins: [stat_panel],
        ...
        methods: {
            getStatistics() {
                ...
                let request = {
                    endpoint: 'stats_affinity_notes_by_day_chart',
                    fields: ['stats'],
                    params: {
                ...
                this.$graph.getEndPointQuery(request)
                    .then((response) => {
                        console.log('CDR affinity notes by day', response);
        ...
        computed: {
            displayTitle() {
                ...
                if (this.user_id) return 'Affinity Notes per Day for User ID: ' + this.user_id;

                return 'Affinity Notes per Day';
            },
