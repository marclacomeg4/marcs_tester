...
<script>
    ...
    export default {
        name: 'payment-transactions-by-hour-chart',
        template: 'payment-transactions-by-hour-chart',
        ...
        methods: {
            getStatistics() {
                ...
                let request = {
                    endpoint: 'stats_payment_transactions_by_hour_chart',
                    fields: ['stats'],
                    params: {
                ...
                this.$graph.getEndPointQuery(request)
                    .then((response) => {
                        console.log('CDR payments by hour', response);
        ...
        computed: {
            displayTitle() {
                ...
                if (this.user_id) return 'Payment Transactions per Hour for User ID: ' + this.user_id;

                return 'Payment Transactions per Hour';
            },
